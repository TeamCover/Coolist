...
import com.flipbox.cover.coolist.adapter.NavigationDrawerAdapter;
import com.flipbox.cover.coolist.model.NavDrawerItem;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(),recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int positon) {
                drawerListener.onDrawerItemSelected(view, positon);
